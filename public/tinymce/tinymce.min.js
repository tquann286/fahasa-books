...
!(function () {
  ...
  var Re,
    ...
    xn = function (e) {
      ...
      return r === n
        ? Cn(r.offsetLeft, r.offsetTop)
        : yn(e)
        ? ((t = n.getBoundingClientRect()), Cn(t.left, t.top))
        : Cn(0, 0)
    },
    Sn = function (e) {
    ...
    En = function (e, t) {
      gt().browser.isSafari() && m(e.dom.scrollIntoViewIfNeeded)
  ...
  var Qr,
    ...
    So = function (e) {
      var t = e.container()
      return (
        !!Fn(t) && (t.data.charAt(e.offset()) === go || (e.isAtStart() && Co(t.previousSibling)))
      )
    },
    No = function (e) {
      var t = e.container()
    ...
    Vo = function (e, t) {
      return (
        (Mo(e) && !1 === ((o = t), Fn((r = e)) && jo(r.data) && !1 === Ho(r, o))) ||
        (Tn((n = e)) &&
          'A' === n.nodeName &&
          !n.hasAttribute('href') &&
    ...
    Jo = function (e, t, n) {
      ...
      return (
        !Tn(t) ||
          (1 === (o = t.childNodes).length && Yo(o[0]) && t.parentNode.insertBefore(o[0], t)),
        jn((a = t)) ||
          zn(a) ||
          Vo(t, r) ||
          (Tn((i = t)) && 0 < i.childNodes.length) ||
          Go(t, r) ||
          e.remove(t),
        t
      )
    ...
    wi = function (i) {
      var e,
        ...
        g = function (e, t, n) {
          ...
          return (
            r
              ? (r = gi(r, /[, ]/, gi(r.toUpperCase(), /[, ]/)))
              : (r = di[e]) ||
                ((r = gi(t, ' ', gi(t.toUpperCase(), ' '))), (r = hi(r, n)), (di[e] = r)),
            r
          )
        },
        p =
    ...
    Ti = function (e, t) {
      ...
      return (
        ...
        !(s.stopImmediatePropagation = function () {
          ...
          ((s.isDefaultPrevented = !0 === s.defaultPrevented ? _i : ki),
                ...
                if (t)
                  for (r = l.length; r--; )
                    l[r].func === t &&
                      ...
                      (i[o] = l))
                ;(t && 0 !== l.length) ||
                  (delete i[o], Ri(n, l.fakeName || o, l.nativeHandler, l.capture))
              }
          } else
            se(i, function (e, t) {
  ...
  var Da = function (e, t, n, r) {
    ...
    if (
      ((t ? t.ownerDocument || t : Ji) !== qi && Vi(t), (n = n || []), !e || 'string' != typeof e)
    )
      return n
      ...
      if ((o = ka.exec(e)))
        if ((a = o[1])) {
          ...
          if ((a = o[3]) && Bi.getElementsByClassName)
            return ca.apply(n, t.getElementsByClassName(a)), n
        }
    ...
    return (
      ...
      Ba(function (e, t, n, r) {
        var o,
          ...
          d = p ? (v || (e ? m : c || h) ? [] : t) : f
        if ((p && p(f, d, n, r), h))
          for (o = ja(d, s), h(o, [], n, r), i = o.length; i--; )
            (a = o[i]) && (d[s[i]] = !(f[s[i]] = a))
        if (e) {
          if (v || m) {
            if (v) {
                    ...
                    (1 &
                      (n =
                        (e.ownerDocument || e) === (t.ownerDocument || t)
                          ...
                          : 1) ||
                    (!Bi.sortDetached && t.compareDocumentPosition(e) === n)
        ...
        filter: {
                ...
                ea(e, function (e) {
                  return t.test(
                    ('string' == typeof e.className && e.className) ||
                      (typeof e.getAttribute != oa && e.getAttribute('class')) ||
                      ''
                  )
                }))
            )
          ...
          PSEUDO: function (e, i) {
            var t,
              a =
                Pi.pseudos[e] ||
                Pi.setFilters[e.toLowerCase()] ||
                Da.error('unsupported pseudo: ' + e)
            return a[Gi]
              ? a(i)
              : 1 < a.length
              ? ((t = [e, e, '', i]),
    ...
    (Mi = Da.tokenize =
      function (e, t) {
        ...
        for (a = e, u = [], s = Pi.preFilter; a; ) {
          for (i in ((n && !(r = va.exec(a))) ||
            (r && (a = a.slice(r[0].length) || a), u.push((o = []))),
          (n = !1),
          (r = ya.exec(a)) &&
            ((n = r.shift()),
            o.push({ value: n, type: r[0].replace(ha, ' ') }),
            (a = a.slice(n.length))),
          Pi.filter))
            Pi.filter.hasOwnProperty(i) &&
              (!(r = xa[i].exec(a)) ||
                (s[i] && !(r = s[i](r))) ||
                ((n = r.shift()),
      ...
      function (e, t, n, r) {
        ...
        if (((n = n || []), 1 === l.length)) {
          if (
            ...
            9 === t.nodeType &&
            Wi &&
            Pi.relative[i[1].type]
          ) {
            if (!(t = (Pi.find.ID(a.matches[0].replace(Ra, Ta), t) || [])[0])) return n
            c && (t = t.parentNode), (e = e.slice(i.shift().value.length))
          }
          for (
            o = xa.needsContext.test(e) ? 0 : i.length;
            o-- && ((a = i[o]), !Pi.relative[(u = a.type)]);

          )
            if (
              (s = Pi.find[u]) &&
              (r = s(a.matches[0].replace(Ra, Ta), (_a.test(i[0].type) && Ia(t.parentNode)) || t))
            ) {
  ...
  ;(uu.fn = uu.prototype =
    {
      ...
      add: function (e, t) {
        ...
        if (!1 !== t)
          for (
            n = hu.unique(this.toArray().concat(hu.makeArray(e))), this.length = n.length, r = 0;
            r < n.length;
            r++
          )
            this[r] = n[r]
      ...
      remove: function () {
        for (var e, t = this.length; t--; )
          (e = this[t]), Ka.clean(e), e.parentNode && e.parentNode.removeChild(e)
        return this
      },
      empty: function () {
        for (var e, t = this.length; t--; )
    ...
    At.extend(uu, {
      ...
      filter: function (e, t, n) {
        ...
        return (t =
          1 === t.length ? (hu.find.matchesSelector(t[0], e) ? [t[0]] : []) : hu.find.matches(e, t))
      },
    })
    ...
    function (r, o) {
      uu.fn[r] = function (t) {
        ...
        this.each(function () {
          ...
          1 < this.length &&
            (Xa[r] || (n = hu.unique(n)), 0 === r.indexOf('parents') && (n = n.reverse()))
        var e = hu(n)
        ...
        var u = function () {
          ...
          ;(n.length = 0),
            ...
            o.loading ||
              ...
              Eu(e, function (e) {
                0 === i.length
                  ? m(e.success) && e.success.call(e.scope)
                  : m(e.failure) && e.failure.call(e.scope, i)
              }))
        }
        u()
      }),
    ...
    Pu = function () {
      var o = [],
        ...
        d = function (o, i, a, u, e) {
          var t, n
          r[o] ||
            (0 !== (t = 'string' == typeof i ? i : i.prefix + i.resource + i.suffix).indexOf('/') &&
              -1 === t.indexOf('://') &&
              (t = Pu.baseURL + '/' + t),
          ...
          !1 !== Pu.languageLoad &&
            e(
              ...
              function () {
                ...
                !e ||
                  (n && -1 === (',' + (n || '') + ',').indexOf(',' + e + ',')) ||
                  _u.ScriptLoader.add(r[t] + '/langs/' + e + '.js')
              },
              'loaded'
            )
        },
    ...
    Is = function (e) {
      var t,
        ...
        i = function (e, t) {
          ...
          if (t < e.data.length) {
            ...
            if (ys(e.data[t - 1]) && (n.setStart(e, t), n.setEnd(e, t + 1), !Os(n)))
              return o(Ls(Ps(n), !1)), r
          }
          0 < t && (n.setStart(e, t - 1), n.setEnd(e, t), Os(n) || o(Ls(Ps(n), !1))),
            t < e.data.length && (n.setStart(e, t), n.setEnd(e, t + 1), Os(n) || o(Ls(Ps(n), !0)))
        }
      ...
      if (bs(e.container()))
        if (e.isAtEnd())
          ...
          if (((n = As(e.container(), e.offset())), Es(n) && i(n, 0), Ss(n) && e.isAtEnd()))
            return o(Ls(Ps(n), !1)), r
  ...
  var Fs,
    ...
    Dc = function (e, t) {
      return Ec(e) && t.container() === e
        ? ((r = t),
          (o = _c((n = e).data.substr(0, r.offset()))),
          (i = _c(n.data.substr(r.offset()))),
          0 < (o.text + i.text).length ? (Ac(n), Ms(n, r.offset() - o.count)) : r)
        : Rc(e, t)
      var n, r, o, i
    },
    Oc = function (e, t) {
    ...
    Bc = function (e) {
      Nc(e) && wo(e) && (xo(e) ? e.removeAttribute('data-mce-caret') : kc(e)),
        Ec(e) && (Ac(e), 0 === e.data.length && kc(e))
    },
    Pc = gt().browser,
    Lc = $n,
    Ic = Kn,
      ...
      var r,
        ...
        s =
          'BODY' === e.tagName
            ...
            : ((a = e.getBoundingClientRect()), (o = e.scrollLeft - a.left), e.scrollTop - a.top)
      return (
        (u.left += o),
        (u.right += o),
        (u.top += s),
    ...
    Uc = function (e, i, a, t) {
      var n,
        ...
        l = function () {
          !(function (e) {
            for (
              var t = $u(Tt.fromDom(e), '*[contentEditable=false],video,audio,embed,object'), n = 0;
              n < t.length;
              n++
            ) {
              var r,
              ...
              _o(i) &&
                ...
                (i = o.nextSibling),
                ko(i) &&
                  (1 === (r = i.data).length ? i.parentNode.removeChild(i) : i.deleteData(0, 1))
            }
          })(i),
            u && (Bc(u), (u = null)),
        ...
        f = function () {
          n = Kr.setInterval(function () {
            t()
              ? hu('div.mce-visual-caret', i).toggleClass('mce-visual-caret-hidden')
              : hu('div.mce-visual-caret', i).addClass('mce-visual-caret-hidden')
          }, 500)
        }
      return {
        show: function (t, e) {
          ...
          var o = hu('<div class="mce-visual-caret" data-mce-bogus="all"></div>')
            .css(n)
            .appendTo(i)[0]
          return (
    ...
    il = function (e, t, n) {
      ...
      if (bo(u)) {
        if (
          (Xc(u) || (u = u.parentNode),
          'before' === (o = u.getAttribute('data-mce-caret')) && ((r = u.nextSibling), Hc(r)))
        )
          return rl(r)
  ...
  var fl,
    ...
    Nl = function (e, t, n) {
      ...
      if (t.isEqual(Ms.after(n)) && n.lastChild) {
        if (((a = Ms.after(n.lastChild)), e < 0 && bl(n.lastChild) && vl(n.lastChild)))
      ...
      if (hl(l)) {
        ...
        if (e < 0 && 0 < f && ((o = xl(l, f - 1)), bl(o)))
          return !Cl(o) && (i = Jc(o, e, wl, o))
            ? hl(i)
              ? Ms(i, i.data.length)
              : Ms.after(i)
            : hl(o)
        ...
        if (0 < e && f < l.childNodes.length && ((o = xl(l, f)), bl(o)))
          return yl(o)
            ? ((u = n),
              (c = (s = o).nextSibling) && bl(c)
                ? hl(c)
                  ? Ms(c, 0)
                  : Ms.before(c)
                : Nl(Fs.Forwards, Ms.after(s), u))
            : !Cl(o) && (i = Jc(o, e, wl, o))
            ? hl(i)
              ? Ms(i, 0)
              : Ms.before(i)
    ...
    Rl = function (e, t, n) {
      return e
        ? !Al(t, n) && ((r = t), !(!Ms.isTextPosition(r) && Hn(r.getNode()))) && _l(t) && kl(n)
        : !Al(n, t) && kl(t) && _l(n)
      var r
    },
    Tl = function (e, t, n) {
    ...
    Bl = function (e, t) {
      ...
      return Fn(u)
        ? U.some(Ms(u, e ? 0 : u.data.length))
        : u
        ? Mo(u)
          ? U.some(e ? Ms.before(u) : Hn((a = u)) ? Ms.before(a) : Ms.after(a))
          : ((r = t), (o = u), (i = (n = e) ? Ms.before(o) : Ms.after(o)), Tl(n, r, i))
        : U.none()
    },
    Pl = k(Tl, !0),
    Ll = k(Tl, !1),
        ...
        if (t.hasOwnProperty('id'))
          return (
            ...
            us(a, u.or(a), function (e, t) {
              var n = o.createRng()
              return (
                n.setStart(jl(o, e.container()), e.offset()),
      ...
      if (
        ...
        for (
          u < (i = s.childNodes).length
            ? ((s = i[u]), (r = new Gr(s, e.getParent(s, e.isBlock))))
            : ((s = i[i.length - 1]), (r = new Gr(s, e.getParent(s, e.isBlock))).next(!0)),
            o = r.current();
          o;
          o = r.next()
        )
    ...
    Rf = function (e, t, n, r, o) {
      ...
      for (;;) {
        ...
        for (i = u[s]; i; i = i[s]) {
          ...
          if (
            !vf(i) &&
            (!Hn((a = i)) || !a.getAttribute('data-mce-bogus') || a.nextSibling) &&
            !bf(i, l)
          )
            return u
        }
    ...
    Df = function (e, t, n, r) {
      ...
      return (
        ...
        Tn(a) &&
          a.hasChildNodes() &&
          ((a = hs(a, t.collapsed ? u : u - 1)), Fn(a) && (u = a.nodeValue.length)),
        (o = wf(s, o)),
        (a = wf(s, a)),
        Tf(o) &&
          ((o = vf(o) ? o : o.parentNode),
          (o = t.collapsed ? o.previousSibling || o : o.nextSibling || o),
          Fn(o) && (i = t.collapsed ? o.length : 0)),
        Tf(a) &&
          ((a = vf(a) ? a : a.parentNode),
        ...
        (n[0].inline || n[0].block_expand) &&
          ((n[0].inline && Fn(o) && 0 !== i) || (o = Rf(s, n, o, i, !0)),
          (n[0].inline && Fn(a) && u !== a.nodeValue.length) || (a = Rf(s, n, a, u, !1))),
        n[0].selector &&
          !1 !== n[0].expand &&
          !n[0].inline &&
          ((o = kf(s, n, t, o, 'previousSibling')), (a = kf(s, n, t, a, 'nextSibling'))),
        (n[0].block || n[0].selector) &&
          ((o = _f(e, n, o, 'previousSibling')),
          (a = _f(e, n, a, 'nextSibling')),
          n[0].block &&
            (s.isBlock(o) || (o = Rf(s, n, o, i, !0)), s.isBlock(a) || (a = Rf(s, n, a, u, !1)))),
    ...
    Bf = function (e, t, u) {
      var n = t.startContainer,
        ...
        s = function (e) {
          var t = e[0]
          return (
            3 === t.nodeType && t === n && r >= t.nodeValue.length && e.splice(0, 1),
            (t = e[e.length - 1]),
      ...
      if (
        (1 === n.nodeType && n.hasChildNodes() && (n = Of(n, r)),
      ...
      return us(
        ...
        Fn(a)
          ? 0 === u
            ? U.some(Tt.fromDom(a))
            : U.none()
          : U.from(a.childNodes[u]).map(Tt.fromDom)),
        ((n = (t = e).endContainer),
        (r = t.endOffset),
        Fn(n)
          ? r === n.data.length
            ? U.some(Tt.fromDom(n))
            : U.none()
          : U.from(n.childNodes[r - 1]).map(Tt.fromDom)),
        function (e, t) {
          var n = W(Ff(o), k(Pt, e)),
            r = W(Uf(o), k(Pt, t))
    ...
    Kf = function (r, o, i, a) {
      return Kt(o).fold(
        ...
        function (e) {
          return 'br' === a || (jt((n = o)) && Wf(n) === go)
            ? 'valid'
            : zt((t = o)) && Vu(t, Wu())
            ? 'existing'
            : Ul(o.dom)
            ? 'caret'
            : rf(r, i, a) && rf(r, Mt(e), i)
            ? 'valid'
            : 'invalid-child'
          var t, n
        }
  ...
  var Zf = function (e, t) {
      ...
      var f,
        ...
        M = function (e) {
          ...
          return (
            ...
            (k.hasClass(e, 'mce-preview-object')
              ? Ot(Tt.fromDom(e.firstElementChild), t)
              : Ot(Tt.fromDom(e), t))
          )
        },
        a = function (e, t, n) {
        ...
        U = function (e) {
          ...
          ;(w = s * g[2] + v),
            ...
            (w = w < 5 ? 5 : w),
            (x = x < 5 ? 5 : x),
            ((P(f) || L(f)) && !1 !== l.getParam('resize_img_proportional', !0, 'boolean')
              ? !nd.modifierPressed(e)
              : nd.modifierPressed(e)) &&
              (T(s) > T(c) ? ((x = D(w * b)), (w = D(x / b))) : ((w = D(x / b)), (x = D(w * b)))),
            F(d, w, x),
            ...
            C ||
              ...
              (a = y),
              (u = 'corner-' + g.name),
              r.fire('ObjectResizeStart', { target: o, width: i, height: a, origin: u }),
              (C = !0))
        },
        z = function () {
          var e,
          ...
          ;(C = !1),
            ...
            i &&
              ...
              (r = x),
              (o = 'corner-' + g.name),
              e.fire('ObjectResized', { target: t, width: n, height: r, origin: o }),
            ...
            ? _(B, function (r, o) {
                var t = function (e) {
                    ...
                    ;(p = e.screenX),
                      ...
                      (d = L((t = f))
                        ? k.create('img', { src: St.transparentSrc })
                        : t.cloneNode(!0)),
        ...
        o = function (e) {
          ...
          C ||
            ...
            n(
              (t = k.$(t).closest('table,img,figure.image,hr,video,span.mce-preview-object')[0]),
              O
    ...
    ld = function (e, t, n) {
      for (
        var r = new Gr(t, e.getParent(t.parentNode, e.isBlock) || e.getRoot());
        (t = r[n ? 'prev' : 'next']());
    ...
    dd = function (e, t, n, r) {
      ...
      if (
        (Tn(l) && f > l.childNodes.length - 1 && (g = !1), zn(l) && ((l = s), (f = 0)), l === s)
      ) {
        ...
        if (l.hasChildNodes()) {
          if (
            ((f = Math.min(!g && 0 < f ? f - 1 : f, l.childNodes.length - 1)),
            (l = l.childNodes[f]),
      ...
      return (
        t === r && Fn(t)
          ? 0 < n &&
            ...
            ((t = (r = gd(t, n)).previousSibling),
            n < o
              ? ((t = r = gd(r, (o -= n)).previousSibling), (o = r.nodeValue.length), (n = 0))
              : (o = 0))
          : (Fn(t) && 0 < n && n < t.nodeValue.length && ((t = gd(t, n)), (n = 0)),
            Fn(r) &&
              0 < o &&
              o < r.nodeValue.length &&
              (o = (r = gd(r, o).previousSibling).nodeValue.length)),
  ...
  var vd,
    ...
    Nd = /* */ Object.freeze({
      ...
      view: function (e) {
        ...
        return (
          e.dom === document
            ? U.none()
            : U.from(null === (t = e.dom.defaultView) || void 0 === t ? void 0 : t.frameElement)
        ).map(Tt.fromDom)
      },
      owner: $t,
    }),
    ...
    Td = function (e, t, n, r, o) {
      ...
      ;(i = u),
        e.fire('ScrollIntoView', i).isDefaultPrevented() ||
          (n(t, Sn(t).top, r, o), (a = u), e.fire('AfterScrollIntoView', a))
    },
    Dd = function (e, t, n, r) {
    ...
    rm = function (e) {
      ...
      return (
        (t = r.dom),
        ((n = t.getSelection()) && 0 !== n.rangeCount ? U.from(n.getRangeAt(0)) : U.none())
          .map(nm)
          .filter(em(e))
      )
    },
    ...
    mm = function (e, t) {
      e.focusedEditor === t.editor && (e.focusedEditor = null),
        e.activeEditor || (lm.unbind(document, 'focusin', wd), (wd = null))
    },
    gm = function (t, e) {
      return (
        (n = e).collapsed ? U.from(hs(n.startContainer, n.startOffset)).map(Tt.fromDom) : U.none()
      ).bind(function (e) {
    ...
    bm = function (e) {
      return e.inline
        ? (n = e.getBody()) && vm(Tt.fromDom(n))
        : (t = e).iframeElement && Vd(Tt.fromDom(t.iframeElement))
      var t, n
    },
    Cm = function (t) {
      var e = t.selection,
      ...
      t.inline || (St.opera || hm(n), t.getWin().focus()),
        (St.gecko || t.inline) && (hm(n), pm(t, r)),
        wm(t)
    },
    wm = function (e) {
      ...
      return (
        ...
        (/^data:image\//i.test(t)
          ? ((r = e.allow_svg_data_urls),
            (o = n),
            !(X(r) ? M(Bm, o) : r) && /^data:image\/svg\+xml/i.test(t))
          : /^data:/i.test(t))
      )
      var r, o
    },
        ...
        n = function (f, e) {
          ...
          for (
            ...
            if ((x < t.index && T(E(w.substr(x, t.index - x))), (i = t[7])))
              ...
              u ||
                (g && g.indexOf('/') === g.length - 1 ? c && Q(i) : S.push({ name: i, valid: c }))
            } else if ((i = t[1])) D(i)
            else if ((i = t[2])) {
              if (
                !(
        ...
        (o =
          'raw' === t.format
            ...
            : ((a = (i = e).serializer.serialize(r, t)),
              ...
              a.replace(s, ''))),
        M(['text', 'tree'], t.format) || lo(Tt.fromDom(r))
          ? (t.content = o)
          : (t.content = At.trim(o)),
          ...
          var m = function (e) {
            ...
            if (l) l(e)
              ...
              if (
                ...
                (n = e.shortEnded),
                (r = e.attributes),
                f && r && 1 < r.length && (((a = []).map = {}), (c = g.getElementRule(e.name))))
              ) {
  ...
  var Wm,
    ...
    $g = function (l, e) {
      return U.some(e)
        ...
        .bind(function (e) {
          ...
          (u = (a = c).data),
          (s = Ms(a, 0)),
          !(!Hg(u, 0) || jg(i, s) || ((a.data = ' ' + u.slice(1)), 0)) ||
            qg(c) ||
            ((t = l),
            (r = (n = c).data),
            (o = Ms(n, r.length - 1)),
            !(!Hg(r, r.length - 1) || jg(t, o) || ((n.data = r.slice(0, -1) + ' '), 0))))
            ? U.some(e)
            : U.none()
        })
    },
    ...
    Qg = function (e) {
      return Mo(e.previousSibling)
        ? U.some(((t = e.previousSibling), Fn(t) ? Ms(t, t.data.length) : Ms.after(t)))
        : e.previousSibling
    ...
    Zg = function (e) {
      return Mo(e.nextSibling)
        ? U.some(((t = e.nextSibling), Fn(t) ? Ms(t, 0) : Ms.before(t)))
        : e.nextSibling
        ? Il(e.nextSibling)
        : U.none()
      var t
    ...
    wp = function (e, t) {
      var n,
        ...
        s =
          ((o = u), (i = lp((r = t).startContainer, o)), (a = lp(r.endContainer, o)), us(i, a, sp))
      return bp(s, t, u)
        .map(function (e) {
    ...
    Mp = function (e, t) {
      ...
      return (
        ...
        ('br' === (n = t.firstChild).name || n.value === mo)
      )
    },
    Fp = function (e, t) {
      var n,
    ...
    Wp = function (e) {
      ...
      ;(r = t),
        (o = n),
        null !== (i = a) && i === r.getParent(o.endContainer, $p) && zf(Tt.fromDom(i), o)
          ? Np(e, n, Tt.fromDom(a))
    ...
    Kp = function (e, t, n) {
      ...
      if ((y = e.fire('BeforeSetContent', y)).isDefaultPrevented())
        e.fire('SetContent', { content: y.content, format: 'html', selection: !0, paste: n.paste })
      else {
        ...
        if (!0 === n.paste && Fp(e.schema, F) && jp(m, r))
          return (a = qp(h, m, d.getRng(), F)), d.setRng(a), void e.fire('SetContent', y)
        if (
          (!(function (e) {
        ...
        U.from(u.getBody()).fold(E(s), function (e) {
          return Gp(s)
            ? (function (e, t, n, r) {
                ...
                return (
                  (r.content = lo(Tt.fromDom(t)) ? o : At.trim(o)),
                  Jp(e, r.content),
            ...
            : ((t = u),
              ...
              0 === (r = s).length || /^\s+$/.test(r)
                ? ((a = '<br data-mce-bogus="1">'),
                  ...
                  (r =
                    (i = fc(t)) && t.schema.isValidChild(n.nodeName.toLowerCase(), i.toLowerCase())
        ...
        if ('undefined' == typeof c.length) {
          for (a in c)
            if (c.hasOwnProperty(a)) {
              if (((u = 'attributes' === r ? e.getAttrib(t, a) : cf(e, t, a)), o && !u && !n.exact))
                return
      ...
      if (c && t)
        for (a = 0; a < c.length; a++)
          if (
            ...
            if ((s = i.classes))
              for (u = 0; u < s.length; u++) if (!e.dom.hasClass(t, af(s[u], r))) return
            return i
          }
    },
    sh = function (e, t, n, r) {
    ...
    ph = function (e) {
      ...
      return (
        Jn(t, { id: dh, 'data-mce-bogus': '1', 'data-mce-type': 'format-caret' }),
      ...
      i &&
        (o
          ...
          : ((s = zl(e.getBody(), i)),
            ...
            (g = null !== s ? s : i),
            (p = (d = e).dom),
            (h = p.getParent(g, k(nf, d))) && p.isEmpty(h)
    ...
    wh = function (i) {
      i.on('mouseup keydown', function (e) {
        ...
        ;(t = i),
          ...
          (8 !== n && 46 !== n) ||
            !r.isCollapsed() ||
            r.getStart().innerHTML !== fh ||
            vh(t, zl(o, r.getStart())),
  ...
  var kh = At.each,
    ...
    qh = function (e, r, o, t, i) {
      ...
      if (
        ...
        !(
          Mh((s = t), (c = r).inline) ||
          Mh(s, c.block) ||
          (c.selector && Tn(s) && u.is(s, c.selector)) ||
        ...
        Ih(r.styles, function (e, t) {
          ...
          Ih(r.attributes, function (e, t) {
            ...
            if (
              ...
              if (
                (Lh.test(t) && y.removeAttribute('data-mce-' + t),
                'style' === t && Dn(['li'])(y) && 'none' === l.getStyle(y, 'list-style-type'))
              )
                return y.removeAttribute(t), void l.setStyle(y, 'list-style-type', 'none')
              ...
              ? p === h.getRoot() &&
                ((m.list_block && Mh(d, m.list_block)) ||
                  Y(ie(d.childNodes), function (e) {
                    rf(f, v, e.nodeName.toLowerCase())
                      ? g
                        ? g.appendChild(e)
                        : ((g = jh(h, e, v)), h.setAttribs(g, f.settings.forced_root_block_attrs))
                      : (g = 0)
                  }))
              : h.isBlock(d) &&
                !h.isBlock(p) &&
                (Vh(h, d, !1) ||
                  Vh(h, d.firstChild, !0, !0) ||
    ...
    Wh = function (e, t, n, r, o, i, a, u) {
      ...
      if (n) {
        ...
        !i || (a.mixed && f.isBlock(n)) || (r = f.split(n, r)),
          c && (o.parentNode.insertBefore(c, o), l.appendChild(o), a.inline && Th(f, a, 0, c))
      }
      return r
    },
        ...
        p = function (e) {
          ...
          Fn(e) && hf(u, r) && $h(s, m, l, r, r),
            Tn(e) &&
              ...
              ((t = a), (a = 'true' === u.getContentEditable(e)), (n = !0))
          ...
          if (m.split) {
            if (((r = pd(r)), (t = Uh(s, r, !0)) !== (n = Uh(s, r)))) {
              if (((t = zh(t, !0)), (n = zh(n, !1)), Fh(u, t, n))) {
                ...
                return (
                  g(Hh(u, o, !0, 'span', { id: '_start', 'data-mce-type': 'bookmark' })), void h(!0)
                )
              }
              if (Fh(u, n, t)) {
                o = U.from(n.lastChild).getOr(n)
                return (
                  g(Hh(u, o, !1, 'span', { id: '_end', 'data-mce-type': 'bookmark' })), void h(!1)
                )
              }
              ;(t = jh(u, t, 'span', { id: '_start', 'data-mce-type': 'bookmark' })),
                (n = jh(u, n, 'span', { id: '_end', 'data-mce-type': 'bookmark' }))
              var i = u.createRng()
              i.setStartAfter(t),
                i.setEndBefore(n),
                Bf(u, i, function (e) {
          ...
          return (
            ...
            (Gh(e, function (e) {
              if (!('collapsed' in e && e.collapsed !== i))
                return a.is(t, e.selector) && !Ul(t) ? (T(t, e), !(n = !0)) : void 0
            }),
            n)
          )
        },
                ...
                s = function (e) {
                  ...
                  if (
                    (Tn(e) &&
                      ...
                      ((n = l), (l = 'true' === S.getContentEditable(e)), (t = !0)),
                    Hn(e) &&
                      !(function (e, t, n, r) {
                  ...
                  if (R.wrapper && uh(E, e, k, _)) u = null
                    ...
                    if (gf(R)) {
                      var a = m(A, e)
                      if (
                        (Fn(e) && hf(S, e.parentNode) && m(A, e.parentNode), !Jh(R, 'inline') || a)
                      )
                        return void (u = null)
                    }
                    !l ||
                    ...
                    Ul(e) ||
                    (Jh(R, 'inline') && S.isBlock(e))
                      ? ((u = null), Gh(At.grep(e.childNodes), s), t && (l = n), (u = null))
                      : (u || ((u = S.clone(d, !1)), e.parentNode.insertBefore(u, e), N.push(u)),
                        u.appendChild(e))
                  }
                }
              Gh(e, s)
                ...
                ? (pf(R) || R.wrapper) &&
                  (R.exact ||
                    ...
                    ((C = w((y = e))) &&
                      !Yl(C) &&
                      ih(S, C, R) &&
                      ((b = S.clone(C, !1)), T(b), S.replace(b, y, !0), S.remove(C, !0)),
                    (e = b || y)),
                  Yh(E, A, _, e),
                  (g = R),
                  (p = k),
                  ...
                  (l = R).styles &&
                    ...
                    Dh(
                      d,
                      Oh(c, 'fontSize'),
                      Bh(c, 'backgroundColor', af(l.styles.backgroundColor, f))
                    ),
                  (i = S),
                  (u = e),
                  (s = function (e) {
                  ...
                  (a = R).styles &&
                    ...
                    (At.walk(u, s, 'childNodes'), s(u)),
                  (t = S),
                  (o = e),
                  ('sub' !== (r = R).inline && 'sup' !== r.inline) ||
                    (Dh(o, Oh(t, 'fontSize'), Bh(t, 'fontSize', '')),
      ...
      if ('false' !== a.getContentEditable(u.getNode())) {
        R &&
          (r
            ? Zl(r)
              ? m(A, r) ||
                ((e = a.createRng()).setStartBefore(r), e.setEndAfter(r), s(a, Df(E, e, A), 0, !0))
              : s(a, r, 0, !0)
            : i && pf(R) && !Mf(E).length
            ? (function (e, t, n) {
                var r,
    ...
    uv = function (e, t) {
      for (var n = e.rows, r = 0; r < n.length; r++)
        for (var o = n[r].cells, i = 0; i < o.length; i++)
          if (Pt(o[i], t)) return U.some({ x: i, y: r })
      return U.none()
    },
      ...
      return (
        Y($u(e, 'tr'), function (n, r) {
          Y($u(n, 'td,th'), function (e, t) {
            !(function (e, t, n, r, o) {
              for (
                var i = iv(o, 'rowspan'), a = iv(o, 'colspan'), u = e.rows, s = n;
                s < n + i;
                s++
              ) {
                u[s] || (u[s] = ov(os(r), []))
    ...
    vv = function (e, t) {
      ...
      return 0 < o.length
        ? hv(e, o)
        : ((n = e), 0 < (r = t).length && r[0].collapsed ? gv() : pv(n, r[0]))
    },
    yv = function (e, t) {
    ...
    wv = function (e, t, n) {
      ...
      var r,
        ...
        l =
          ...
          (s = km(r, Pf(u))),
          (c = o.contextual ? vv(Tt.fromDom(r.getBody()), s).dom : i.cloneContents()) &&
            a.appendChild(c),
          r.selection.serializer.serialize(a, o))
      return 'tree' === n.format
        ? l
        : ((n.content = e.selection.isCollapsed() ? '' : l), e.fire('GetContent', n), n.content)
    },
    xv = function (e) {
      return Tn(e)
        ? e.outerHTML
        : Fn(e)
        ? fi.encodeRaw(e.data, !1)
        : Un(e)
        ? '\x3c!--' + e.data + '--\x3e'
        : ''
    },
        ...
        undoManager: {
          ...
          undo: function (e, t, n) {
            return (
              ...
              (i = t),
              (a = n),
              (o = e).typing && (o.add(), (o.typing = !1), Bv(o, !1, i)),
              0 < a.get() &&
                (a.set(a.get() - 1),
                (u = o.data[a.get()]),
                Av(r, u, !0),
          ...
          getContent: function (e, t) {
            return (
              ...
              U.from(n.getBody()).fold(
                E('tree' === r.format ? new Tm('body', 11) : ''),
                function (e) {
                  return Um(n, r, o, e)
                }
              )
        ...
        return (
          ...
          t.filter(jt).map(function (e) {
            return (
              ...
              void (r ? (Gg(o, i, !1, !r), n.setStart(i, a)) : (Gg(i, o, !1, !r), n.setEnd(i, a)))
            )
            var t, n, r, o, i, a
          })
        )
  ...
  var $v,
    ...
    Yv = function (u, s, e, c) {
      var l,
        ...
        g = function () {
          ...
          return (
            (t = t || (o.createRange ? o.createRange() : o.body.createTextRange())).setStart &&
        ...
        v = {
          ...
          setCursorLocation: function (e, t) {
            var n = u.createRng()
            V(e) && V(t)
              ? (n.setStart(e, t), n.setEnd(e, t), p(n), o(!1))
              : (jf(u, n, c.getBody(), !0), p(n))
          },
          ...
          getNode: function () {
            return (function (e, t) {
              ...
              return !t.collapsed &&
                ...
                3 === n.nodeType &&
                  3 === r.nodeType &&
                  ((n = n.length === o ? Em(n.nextSibling, !0) : n.parentNode),
          ...
          getSelectedBlocks: function (e, t) {
            return (function (e, t, n, r) {
              var o,
                ...
                a = e.getRoot()
              if (
                ((n = e.getParent(n || Sm(a, t, t.collapsed), e.isBlock)),
    ...
    iy = function (e, t, n, r) {
      ;(e.padd_empty_with_br || t.insert) && n[r.name]
        ? (r.empty().append(new Tm('br', 1)).shortEnded = !0)
        : (r.empty().append(new Tm('#text', 3)).value = mo)
    },
    ay = function (e, t) {
            ...
            if (((i = (o = e[r]).parent), d[o.parent.name] && o === i.lastChild)) {
              ...
              o &&
                ...
                uy(h, m, g, i) &&
                  ...
                  (c.removeEmpty ? i.remove() : c.paddEmpty && iy(p, n, d, i)))
            } else {
              for (a = o; i && i.firstChild === a && i.lastChild === a && !d[(a = i).name]; )
                i = i.parent
              a === i &&
                !0 !== p.padd_empty_with_br &&
                (((l = new Tm('#text', 3)).value = mo), o.replace(l))
            }
        }),
            ...
            for (var t, n, r, o = e.length; o--; ) {
              ;('ul' !== (r = (n = e[o]).parent).name && 'ol' !== r.name) ||
                (n.prev && 'li' === n.prev.name
                  ? n.prev.append(n)
                  : ((t = new Tm('li', 1)).attr('style', 'list-style-type: none'), n.wrap(t)))
            }
          }),
        p.validate &&
          h.getValidClasses() &&
              ...
              k = Im(
                {
                  ...
                  start: function (e, t, n) {
                    ...
                    if (a) {
                      ...
                      if ((S && y[e] && (S = !1), a.removeEmpty && uy(R, m, y, c)))
                        return (
                          (o = c.parent), d[c.name] ? c.empty().remove() : c.unwrap(), void (c = o)
                        )
                      a.paddEmpty &&
                        ((ay((i = c), '#text') && i.firstChild.value === mo) || uy(R, m, y, c)) &&
                        iy(A, u, d, c),
                        (c = c.parent)
                    }
                  },
                      ...
                      for (
                        ...
                        if ((t = e[h]).parent && !t.fixed)
                          if (g[t.name] && 'li' === t.parent.name) {
                            ...
                            for (
                              r = [t], n = t.parent;
                              n && !R.isValidChild(n.name, t.name) && !f[n.name];
                              n = n.parent
                            )
                              r.push(n)
                            if (n && 1 < r.length) {
                              ...
                              R.isValidChild(t.parent.name, 'div') && R.isValidChild('div', t.name)
                                ? t.wrap(P(new Tm('div', 1)))
                                : p[t.name]
                                ? t.empty().remove()
                                : t.unwrap()
                            }
                ...
                (function () {
                  ...
                  if (R.isValidChild(_.name, v.toLowerCase())) {
                    for (; n; )
                      (e = n.next),
                        3 === n.type ||
                        (1 === n.type && 'p' !== n.name && !d[n.name] && !n.attr('data-mce-type'))
                          ? (t || ((t = N(v, 1)).attr(A.forced_root_block_attrs), _.insert(t, n)),
                            t.append(n))
                          : (r(t), (t = null)),
                        (n = e)
                    r(t)
    ...
    vy = function (e, t, n, r, o) {
      ...
      return (
        ...
        (u = o).no_events || !a
          ? s
          : ((c = a), (l = _e(_e({}, u), { content: s })), c.fire('PostProcess', l).content)
      )
    },
    yy = function (y, b) {
        ...
        serialize: function (e, t) {
          ...
          var n,
            ...
            h =
              ...
              o.selection || lo(Tt.fromDom(r)) ? i : At.trim(i)),
            v =
              ((a = x),
              (u = h),
    ...
    Fy = function (e, t, n, r) {
      return e && ((a = i = 'mobile'), (u = (o = t).sections()), Iy(o, i) && u[i].theme === a)
        ? H(r, k(M, Oy))
        : e && Iy(t, 'mobile')
        ? r
        : n
        ...
        d = e
          ? {
              mobile:
                ((i = o.mobile || {}),
                (a = t),
                (u = { resize: !1, toolbar_mode: My(i, 'scrolling'), toolbar_sticky: !1 }),
          ...
          'string' == typeof (i = u)
            ? Y(
                ...
                function (e) {
                  var t = e.split('=')
                  1 < t.length
                    ? (a[At.trim(t[0])] = At.trim(t[1]))
                    : (a[At.trim(t[0])] = At.trim(t[0]))
                }
              )
            : (a = i),
          a)
    ...
    Jy = function (e, t, n) {
      ...
      return (
        (l = h.x), (f = h.y), (d = Ky((c = p))), (m = Xy(c)), 0 <= l && 0 <= f && l <= d && f <= m
      )
    },
    Qy = function (e) {
      var t,
            ...
            return (
              ...
              W(o, function (e) {
                ...
                return (
                  ...
                  o.push(e),
                  u(),
                  n.fire('OpenNotification', { notification: _e({}, t) }),
                  t
                )
              })
            )
  ...
  var nb,
          ...
          return {
            fireIfChanged: function () {
              ...
              oe(t)
                ...
                .each(function (e) {
                  n.setDirty(!0),
                    n.fire('change', { level: e, lastLevel: ne(t, t.length - 2).getOrNull() })
                })
            },
          }
        })(s),
                          ...
                          e.status && s.getParam('images_replace_blob_uris', !0, 'boolean')
                            ...
                            : e.error &&
                              (e.error.options.remove &&
                                (g(i.getAttribute('src'), St.transparentSrc), a.push(i)),
                              (n = s),
                              (r = e.error.message),
        ...
        y = function (t) {
          return (
            ...
            (0 !== t.getAttribute('src').indexOf('data:') ||
              s.getParam('images_dataimg_filter', R, 'function')(t))
          )
        },
        b = function () {
          ...
          (t = e.replace(/(?:([#\.]|::?)([\w\-]+)|(\[)([^\]]+)\]?)/g, function (e, t, n, r, o) {
            switch (t) {
              ...
              case '.':
                ...
                break
              case ':':
                ;-1 !== At.inArray('checked disabled enabled read-only required'.split(' '), n) &&
                  (a.attrs[n] = n)
            }
            var i
            return (
          ...
          if (
            !(
              ('background-color' === e &&
                ...
                ((t = Sb.getStyle(n.getBody(), e, !0)), '#ffffff' === Sb.toHex(t).toLowerCase())) ||
            ...
            ((33 <= n && n <= 36) || (37 <= n && n <= 40) || 45 === n
              ...
              : ((t = (e.ctrlKey && !e.altKey) || e.metaKey),
                !(n < 16 || 20 < n) ||
                  ...
                  r.typing ||
                  t ||
                  (r.beforeChange(), Bv(r, !0, o), r.add({}, e), i.set(!0))))
        }),
        ...
        l = function (e, t) {
          ...
          !(function (e) {
            if (Ob(e)) {
              var t = e.keyCode
              return (
                !Bb(e) && (nd.metaKeyPressed(e) || e.altKey || (112 <= t && t <= 123) || M(Tb, t))
              )
            }
            return !1
          })(e) &&
    ...
    oC = function (e) {
      ...
      return rC(i, a)
        ...
        : ((n = i),
          ...
          (o = r.getRng()),
          us(
            Hb(n, Tt.fromDom(o.startContainer)),
            Hb(n, Tt.fromDom(o.endContainer)),
            function (e, t) {
              return (
                !1 === Pt(e, t) &&
                (o.deleteContents(),
        ...
        e
          ? function (e) {
              if (kC(e.previousSibling))
                return AC(e.previousSibling) || e.previousSibling.appendData(go), e.previousSibling
          ...
          : function (e) {
              if (kC(e.nextSibling))
                return _C(e.nextSibling) || e.nextSibling.insertData(0, go), e.nextSibling
    ...
    JC = function (a, e, u, t, n, s) {
      return us(Fb(e, u, t), Fb(e, u, n), function (e, t) {
        return e !== t && ((r = t), (o = Qc(e, (n = u))), (i = Qc(r, n)), o && o === i)
          ? MC.after(a ? e : t)
          : s
        var n, r, o, i
      }).getOr(s)
    ...
    ZC = function (e, t) {
      return e
        ? t.fold(C(U.some, MC.start), U.none, C(U.some, MC.after), U.none)
        : t.fold(U.none, C(U.some, MC.before), U.none, C(U.some, MC.end))
    },
    ew = function (e, a, u, s) {
      var t = Ub(e, s),
        c = WC(a, u, t)
    ...
    nw = function (e, t) {
      ...
      return (
        !!m(t.selection.getSel().modify) &&
        (e && So(r) ? tw(!0, t.selection, r) : !(e || !No(r)) && tw(!1, t.selection, r))
      )
    }
  ;((rb = nb = nb || {})[(rb.Br = 0)] = 'Br'),
    (rb[(rb.Block = 1)] = 'Block'),
  ...
  var rw,
    ...
    aw = function (e, t, n, r) {
      for (
        var o, i, a, u, s, c, l = El(n), f = r, d = [];
        f && ((s = l), (c = f), (o = t === Fs.Forwards ? s.next(c) : s.prev(c)));

      ) {
        if (Hn(o.getNode(!1)))
          return t === Fs.Forwards
            ? { positions: iw(t, d).concat([o]), breakType: nb.Br, breakAt: U.some(o) }
  ...
  var hw = function (o, i, a, e, u, t) {
        ...
        if (
          (u = _w(
            (function (e, r, t) {
              ...
              return (
                o.push(r), Aw(rw.Up, e, k(n, ds), r.node, t), Aw(rw.Down, e, k(n, ms), r.node, t), o
              )
            })(e, u, s),
            t
          )) &&
      ...
      if ((c = r(a) ? a.getNode() : o(a) ? a.getNode(!0) : ps(n))) {
        var h = (function (e, t, n, r) {
            var o,
              ...
              d =
                1 === e
                  ? ((o = s.next), (i = ms), (a = ds), Ms.after(r))
                  : ((o = s.prev), (i = ds), (a = ms), Ms.before(r)),
              m = f(d)
            do {
      ...
      return (
        d.on('NodeChange', function (e) {
          ...
          !xc(d) ||
            ...
            (s = e.parents),
            (c = z(
              $u(Tt.fromDom(u.getRoot()), '*[data-mce-selected="inline-boundary"]'),
              function (e) {
                return e.dom
              }
            )),
      ...
      e.queryCommandState('InsertUnorderedList') ||
        ...
        Y(ax(e), function (e) {
          ...
          ;(t = l),
            ...
            (s = rx(r, Tt.fromDom(a))),
            'outdent' === n
              ? ((u = Math.max(0, nx(a.style[s]) - o)), t.setStyle(a, s, u ? u + i : ''))
              : ((u = nx(a.style[s]) + o + i), t.setStyle(a, s, u))
        })
    },
    sx = function (e, t) {
        ...
        if (
          ...
          for (
            ...
            if (((p = u), Fn((h = s)) || (Tn(h) && !mx(p, h) && !Yl(h)))) {
              ...
              t || ((t = o.create(l, dc(e))), s.parentNode.insertBefore(t, s), (r = !0)),
                (s = (n = s).nextSibling),
                t.appendChild(n)
    ...
    px = function (e, t) {
      ...
      t.hasAttribute('data-mce-caret') &&
        (Ao(t), (n = e).selection.setRng(n.selection.getRng()), e.selection.scrollIntoView(t))
    },
    hx = function (e, t) {
      var n,
        r =
      ...
      if (r)
        return 'compositionstart' === t.type
          ...
          : void (xo(r) && (px(e, r), e.undoManager.add()))
    },
    vx = $n,
    yx = function (e, t, n) {
      var r,
    ...
    _x = function (e, t, n, r) {
      return '' === t
        ? ((l = e), (f = r), (d = Tt.fromTag('br')), kx(l, d, f), Ex(d))
        : ((o = e),
          (i = r),
          (a = t),
          (u = n),
    ...
    Dx = function (e, r) {
      return J(
        z(e, function (e) {
          return _e(
            { shiftKey: !1, altKey: !1, ctrlKey: !1, metaKey: !1, keyCode: 0, action: te },
            e
          )
        }),
        function (e) {
    ...
    Vx = function (e, t, n) {
      ...
      return ((a = u).breakType === nb.Wrap && 0 === a.positions.length) ||
        (!Hn(n.getNode()) && (i = u).breakType === nb.Br && 1 === i.positions.length)
        ? ((r = e),
          (o = t),
      ...
      n !== e.getBody() &&
        ...
        aS(n, r, !0) && aS(n, r, !1)
          ? rS(n, 'LI')
            ? ((u = iS(n)),
              g.insertAfter(a, u),
              (null === (m = (d = n).parentNode) || void 0 === m ? void 0 : m.firstChild) === d
                ? g.remove(u)
                : g.remove(n))
            : g.replace(a, n)
          : (aS(n, r, !0)
              ...
              : ((n = iS(n)),
                ...
                s.setEndAfter(n),
                (c = s.extractContents()),
                'LI' === o && ((f = 'LI'), (l = c).firstChild && l.firstChild.nodeName === f)
                  ? ((a = c.firstChild), g.insertAfter(c, n))
                  : (g.insertAfter(c, n), g.insertAfter(a, n))),
            g.remove(r)),
        tS(e, a))
    },
    sS = function (e) {
    ...
    fS = function (e, t, n) {
      return !1 === Fn(t)
        ? n
        : e
        ? 1 === n && t.data.charAt(n - 1) === go
          ? 0
          : n
        : n === t.data.length - 1 && t.data.charAt(n) === go
        ? t.data.length
        : n
    },
    dS = function (e, t) {
    ...
    gS = function (a, e) {
      var t,
        ...
        h = function (e) {
          ...
          var o = new Gr(u, s)
          for (
            Fn(u) && (e && 0 === r ? o.prev() : e || r !== u.nodeValue.length || o.next());
            (t = o.current());
        ...
        v = function () {
          ;(n = /^(H[1-6]|PRE|FIGURE)$/.test(c) && 'HGROUP' !== C ? p(N) : p()),
            a.getParam('end_container_on_empty_block', !1) && lS(f, o) && f.isEmpty(s)
              ? (n = f.split(o, s))
              : f.insertAfter(n, s),
            tS(a, n)
        }
        ...
        /^(LI|DT|DD)$/.test(c) && f.isEmpty(s)
          ...
          : (N && s === a.getBody()) ||
            ...
            bo(s)
              ...
              : ((S = (x = g).cloneRange()).setStart(
                  x.startContainer,
                  fS(!0, x.startContainer, x.startOffset)
                ),
                ...
                (function (e) {
                  for (
                    ;
                    Fn(e) && (e.nodeValue = e.nodeValue.replace(/^[\r\n]+/, '')),
                      (e = e.firstChild);
                ...
                (function (e, t, n) {
                  ...
                  if (a) {
                    ...
                    for (r = u.length; r--; )
                      !(a = u[r]).hasChildNodes() ||
                      (a.firstChild === a.lastChild && '' === a.firstChild.nodeValue)
                        ? e.remove(a)
                        : ((o = e), (i = a) && 'A' === i.nodeName && o.isEmpty(i) && e.remove(a))
                  }
                })(f, m, n),
                (function (e, t) {
                  t.normalize()
    ...
    ZS = function (e) {
      var t,
        n = Hw(e)
      return (
        (t = e).on('keyup compositionstart', k(hx, t)),
        Zx(e, n),
        eS(e, n),
        FS(e),
        QS(e),
  ...
  function tN(r) {
    ...
    'onselectionchange' in r.getDoc() ||
      ...
      r.on('SelectionChange', function () {
        ...
        !e ||
          (!St.range && r.selection.isCollapsed()) ||
          (Hf(r) &&
  ...
  var nN = function (e) {
    ...
    bN = function (u) {
      var s,
        ...
        v = function (e, t, n, r) {
          return (
            void 0 === r && (r = !0),
            u.fire('ShowCaret', { target: t, direction: e, before: n }).isDefaultPrevented()
              ? null
          ...
          var r = (function (e, t, n) {
              ...
              t === n && St.ie
                ? (o
                  ...
                  i.setEndAfter(t))
                : (o.empty().append(mo).append(t).append(mo),
            ...
            var a = function (e) {
              ...
              i = function (e, t) {
                var n,
                  ...
                  i = l.getParent(t, f)
                return (
                  !(!o || e === i || !l.isChildOf(o, i) || !1 !== vN(yN(u, o))) ||
                  (o && ((n = o), (r = i), !(l.getParent(n, f) === l.getParent(r, f))) && a(o))
                )
              }
            u.on(
              'tap',
                ...
                ;(o !== d && 'HTML' !== o.nodeName && !l.isChildOf(o, d)) ||
                  ...
                  ((t = yN(u, o))
                    ? vN(t)
                      ...
                      : (x(),
                        (hN(t) && e.shiftKey) ||
                          ed(e.clientX, e.clientY, c.getRng()) ||
            ...
            u.on('AfterSetSelectionRange', function (e) {
              ...
              u.on('copy', function (e) {
                ...
                e.isDefaultPrevented() ||
                  !e.clipboardData ||
                  St.ie ||
                  ((t = (n = l.get(g)) ? n.getElementsByTagName('*')[0] : n) &&
                    (e.preventDefault(),
                    r.clearData(),
      ...
      var n,
            ...
            if (!p(e) && (a === l || a === c)) {
              ...
              e.preventDefault(),
                ...
                n.firstChild && f.isBlock(n.firstChild)
                  ? s.selection.setCursorLocation(n.firstChild, 0)
                  : s.selection.setCursorLocation(n, 0),
                s.nodeChanged()
            }
          })
        },
        ...
        b = function () {
          s.on('click', function (e) {
            ...
            ;/^(IMG|HR)$/.test(t.nodeName) &&
              ...
              (e.preventDefault(), s.selection.select(t), s.nodeChanged()),
              'A' === t.nodeName &&
        ...
        R = function () {
          s.on('dragstart', function (e) {
            var t, n, r
            ;(t = e).dataTransfer &&
              (s.selection.isCollapsed() && 'IMG' === t.target.tagName && d.select(t.target),
              0 < (n = s.selection.getContent()).length &&
                ((r = u + escape(s.id) + ',' + escape(n)), t.dataTransfer.setData(m, r)))
          }),
            s.on('drop', function (e) {
              var t, n, r, o, i, a
              p(e) ||
                ((t =
                  (i = e).dataTransfer && (a = i.dataTransfer.getData(m)) && 0 <= a.indexOf(u)
                    ? ((a = a.substr(u.length).split(',')),
                  ...
                  s.queryCommandSupported('mceInsertClipboardContent')
                    ? s.execCommand('mceInsertClipboardContent', !1, { content: r, internal: o })
              ...
              if (!p(e) && e.keyCode === nd.BACKSPACE) {
                ...
                if (t.collapsed && 0 === r) {
                  ...
                  'BLOCKQUOTE' === i.tagName &&
                    (s.formatter.toggle('blockquote', null, i),
    ...
    AN = function (t) {
      ...
      e.browser_spellcheck ||
        e.gecko_spellcheck ||
        ((n.body.spellcheck = !1), wN.setAttrib(r, 'spellcheck', 'false')),
        (t.quirks = CN(t)),
        t.fire('PostRender')
      var o,
        i,
    ...
    RN = function (t, e) {
      ...
      n.inline || (t.getElement().style.visibility = t.orgVisibility),
        ...
        t.inline &&
          (wN.addClass(r, 'mce-content-body'),
      ...
      ;(c.disabled = !0),
        ...
        t.readonly ||
          (t.inline &&
            'static' === wN.getStyle(c, 'position', !0) &&
        ...
        (t.parser =
          ((i = gy(SN((u = t)), u.schema)).addAttributeFilter(
          ...
          i.addNodeFilter('p,h1,h2,h3,h4,h5,h6,div', function (e) {
            for (var t = e.length, n = u.schema.getNonEmptyElements(); t--; ) {
              ...
              r.isEmpty(n) &&
                ...
                (r.append(new Tm('br', 1)).shortEnded = !0)
            }
          }),
          i)),
        (t.serializer = by(
    ...
    DN = function (e) {
      ...
      var n = cc(e, 'body_id', 'tinymce'),
        r = cc(e, 'body_class', '')
      return (
        lc(e) && (t += '<meta http-equiv="Content-Security-Policy" content="' + lc(e) + '" />'),
        (t +=
          '</head><body id="' +
          n +
    ...
    FN = function (e) {
      ...
      return (
        ...
        K(wc(e))
          ...
          : m(wc(e))
          ? ((n = (t = e).getElement()),
            (r = wc(t)(t, n)).editorContainer.nodeType &&
    ...
    UN = function (e) {
      ...
      e.fire('ScriptsLoaded'),
        ...
        K(u)
          ? ((i.settings.theme = LN(u)),
            ...
            i.theme.init &&
              i.theme.init(i, tb.urls[u] || i.documentBaseUrl.replace(/\/$/, ''), i.$))
          : (i.theme = {}),
        (s = e),
        (c = []),
      ...
      return (
        ...
        e.inline
          ...
          : ((h = ON((g = e), (p = v))),
            p.editorContainer &&
              ((TN.get(p.editorContainer).style.display = g.orgDisplay),
    ...
    $N = function (e, t) {
      ...
      ;(n = s),
        ...
        K(u)
          ? (jN(u) ||
              tb.urls.hasOwnProperty(u) ||
              ((a = r.getParam('theme_url'))
                ? tb.load(u, r.documentBaseURI.toAbsolute(a))
                : tb.load(u, 'themes/' + u + '/theme' + o + '.js')),
        ...
        ? t.getElement() &&
          ...
          (a = t.getElement().form || zN.getParent(e, 'form')) &&
            ...
            t.getParam('hidden_input') &&
              !Mn(t.getElement()) &&
              (zN.insertAfter(zN.create('input', { type: 'hidden', name: e }), e),
              (t.hasHiddenInput = !0)),
    ...
    rE = function (e, t) {
      var n,
        ...
        a =
          'string' != typeof (n = t)
            ? ((r = At.extend({ paste: n.paste, data: { paste: n.paste } }, n)),
        ...
        this.addCommands({
          ...
          unlink: function () {
            ...
            i.selection.isCollapsed()
              ? (e = i.dom.getParent(i.selection.getStart(), 'a')) && i.dom.remove(e, !0)
  ...
  var cE = 'data-mce-contenteditable',
    lE = function (e, t, n) {
      var r, o
      Vu(e, t) && !1 === n
        ? ((o = t), Fu((r = e)) ? r.dom.classList.remove(o) : zu(r, o), Hu(r))
        : n && ju(e, t)
    },
    fE = function (e, t, n) {
      try {
            ...
            u.preventDefault(),
              /^#/.test(e)
                ? (t = a.dom.select(
                    e +
                      ',[name="' +
                      (qe((n = e), (r = '#')) ? ((o = n), (i = r.length), o.substring(i)) : n) +
                      '"]'
            ...
            if (a) {
              if (t)
                for (var u = a.length; u--; )
                  a[u].func === t &&
                    ((a = a.slice(0, u).concat(a.slice(u + 1))), (this.bindings[i] = a))
              else a.length = 0
      ...
      toggleNativeEvent: function (e, t) {
        ...
        'focus' !== e &&
          ...
          (t
            ...
            : n.initialized && (n.dom.unbind(NE(n, e), e, n.delegates[e]), delete n.delegates[e]))
      },
    ...
    LE = function (e) {
      ...
      DE(OE(e.toLowerCase(), '+'), function (e) {
        e in PE
          ...
          : ((n.charCode = e.charCodeAt(0)), (n.keyCode = BE[e] || e.toUpperCase().charCodeAt(0)))
      })
      var r = [n.keyCode]
      for (t in PE) n[t] ? r.push(t) : (n[t] = !1)
      return (
        (n.id = r.join(',')),
        n.access && ((n.alt = !0), St.mac ? (n.ctrl = !0) : (n.shift = !0)),
        n.meta && (St.mac ? (n.meta = !0) : ((n.ctrl = !0), (n.meta = !1))),
        n
      )
    },
    IE =
      ...
      (ME.prototype.createShortcut = function (e, t, n, r) {
        ...
        return (
          (o[o.length - 1] = At.extend(o[o.length - 1], { func: n, scope: r || this.editor })),
        ...
        return (
          0 !==
            (r =
              (n = u.length - o) <= 0
                ? Z(i).join('/')
                : u.slice(0, n).join('/') + '/' + Z(i).join('/')).indexOf('/') && (r = '/' + r),
      ...
      : ((n = 0 === e.indexOf('//')),
        ...
        /^[\w\-]*:?\/\//.test(e) ||
          ((r = this.settings.base_uri
            ...
            : new qE(document.location.href).directory),
          (e =
  ...
  var $E = Su.DOM,
    ...
    GE =
      ...
      (JE.prototype.show = function () {
        this.hidden &&
          ...
          this.inline
            ...
            : ($E.show(this.getContainer()), $E.hide(this.id)),
          this.load(),
          this.fire('show'))
      }),
      (JE.prototype.hide = function () {
        ...
        e.hidden ||
          ...
          e.inline
            ...
            : ($E.hide(e.getContainer()), $E.setStyle(e.id, 'display', e.orgDisplay)),
          (e.hidden = !0),
          e.fire('hide'))
      }),
      ...
      (JE.prototype.resetContent = function (e) {
        e === undefined ? wy(this, this.startContent, { format: 'raw' }) : wy(this, e),
      ...
      (JE.prototype.getContainer = function () {
        return (
          this.container || (this.container = $E.get(this.editorContainer || this.id + '_parent')),
          this.container
        )
      }),
  ...
  function JE(e, t, n) {
    ...
    ;(this.plugins = {}),
      ...
      this.settings.referrer_policy &&
        (_u.ScriptLoader._setReferrerPolicy(this.settings.referrer_policy),
      ...
      this.settings.cache_suffix &&
        (St.cacheSuffix = this.settings.cache_suffix.replace(/^[\?\&]+/, '')),
      (this.ui = {
        registry: FE(),
  ...
  var QE,
    ...
    sk = function (e) {
      e !== ok &&
        (e ? hu(window).on('resize scroll', uk) : hu(window).off('resize scroll', uk), (ok = e))
    },
    ck = function (t) {
      var e = ak
      delete ik[t.id]
      ...
      setup: function () {
        ...
        if (o) (e = o.base || o.baseURL), (t = o.suffix)
          ...
          !e &&
            ...
            (-1 !== (i = document.currentScript.src).indexOf('.min') && (t = '.min'),
        ...
        if (e) {
          if (!K(e))
            return (
              ...
              a(r.get(n.id))
                ? null
                : (ck(n) && r.fire('RemoveEditor', { editor: n }),
