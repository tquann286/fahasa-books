...
!(function () {
  ...
  var t,
    ...
    S = {
      ...
      none: D,
      from: function (e) {
        return null === e || e === undefined ? A : w(e)
      },
    },
    x = Object.keys,
    ...
    U = function (e, n, r, i) {
      return (
        (function (e, t) {
          for (var n = x(e), r = 0, i = n.length; r < i; r++) {
            var a = n[r]
            t(e[a], a)
          }
        })(e, function (e, t) {
    ...
    O = function (e, t) {
      return (n = e), (r = t), C.call(n, r) && e[t] !== undefined && null !== e[t]
      var n, r
    },
    ...
    E = {
      ...
      fromPoint: function (e, t, n) {
        return S.from(e.dom.elementFromPoint(t, n)).map(_)
      },
    },
    ...
    Q = function (e) {
      ...
      X(e)
        ...
        : ((t = e),
          ...
          W.insertAfter(n, t),
          n.appendChild(t),
          n.appendChild(W.create('figcaption', { contentEditable: 'true' }, 'Caption')),
    ...
    de = function (e, t, n) {
      var r, i
      n
        ? (W.setAttrib(e, 'role', 'presentation'), (r = E.fromDom(e)), P(r, 'alt', ''))
        : (m(t)
            ? ((r = E.fromDom(e)), (i = 'alt'), r.dom.removeAttribute(i))
            : ((r = E.fromDom(e)), P(r, 'alt', t)),
    ...
    fe = function (e, t, n) {
      ...
      me(n, o, t, 'caption', function (e, t, n) {
        ...
        (r = n),
        (i = o),
        ((a = t).alt === i.alt && a.isDecorative === i.isDecorative) || de(r, a.alt, a.isDecorative)
    },
    pe = function (e, t) {
    ...
    be = function (n, e) {
      var t = n.dom,
        r = I(n.schema.getTextBlockElements(), function (e, t) {
          return !n.schema.isValidChild(t, 'figure')
        }),
        i = t.getParent(
          e.parentNode,
          function (e) {
            return O(r, e.nodeName)
          },
          n.getBody()
        )
    ...
    ve = function (t, e) {
      var n = (function (e, t) {
        var n = document.createElement('img')
        if ((fe(e, c(c({}, t), { caption: !1 }), n), de(n, t.alt, t.isDecorative), t.caption)) {
          var r = W.create('figure', { class: 'image' })
          return (
            r.appendChild(n),
            r.appendChild(W.create('figcaption', { contentEditable: 'true' }, 'Caption')),
      ...
      return (
        Se.each(e, function (e) {
          var t,
            n,
            r,
            i = v((t = e).text) ? t.text : v(t.title) ? t.title : ''
          e.menu !== undefined
            ? ((n = Ce(e.menu, a)), o.push({ text: i, items: n }))
    ...
    Pe = function (r) {
      var t,
        ...
        s = y(r.getParam('images_upload_url')),
        u = y(r.getParam('images_upload_handler')),
        c = (e = he((t = r)))
          ? ce(function (e) {
              return pe(t, e)
            }, e)
        ...
        b = S.some(r.getParam('image_prepend_url', '', 'string')).filter(function (e) {
    ...
    Be = function (e, t) {
      ...
      l !== undefined &&
        ...
        (i = n),
        (a = l),
        (r = e).hasDescription && v(a.alt) && (i.alt = a.alt),
        r.hasAccessibilityOptions && (i.isDecorative = a.isDecorative || i.isDecorative || !1),
        r.hasImageTitle && v(a.title) && (i.title = a.title),
        r.hasDimensions &&
          (v(a.width) && (i.dimensions.width = a.width),
          v(a.height) && (i.dimensions.height = a.height)),
        v(a['class']) &&
          Ne(r.classList, a['class']).each(function (e) {
            i.classes = e.value
          }),
        r.hasImageCaption && d(a.caption) && (i.caption = a.caption),
        r.hasAdvTab &&
          (v(a.style) && (i.style = a.style),
          v(a.vspace) && (i.vspace = a.vspace),
          v(a.border) && (i.border = a.border),
          v(a.hspace) && (i.hspace = a.hspace),
          v(a.borderstyle) && (i.borderstyle = a.borderstyle)),
        t.setData(n))
    },
    He = function (e, t, n, r) {
      ...
      return (
        (u.vspace =
          (r = s)['margin-top'] && r['margin-bottom'] && r['margin-top'] === r['margin-bottom']
            ...
            : ''),
        (u.hspace =
          (i = s)['margin-right'] && i['margin-left'] && i['margin-right'] === i['margin-left']
            ? B(String(i['margin-right']))
            : ''),
        (u.border = (a = s)['border-width'] ? B(String(a['border-width'])) : ''),
        ...
        L(e.fileinput).fold(
          ...
          function (n) {
            var r,
              ...
              o = function (e) {
                u.setData({ src: { value: e, meta: {} } }), u.showTab('general'), He(l, s, t, u)
              }
            ;(r = n),
              new j(function (e, t) {
    ...
    qe = function (a) {
      return function (e) {
        var t,
          n,
          r,
          i = { prevImage: Ne((t = e).imageList, t.image.src), prevAlt: t.image.alt, open: !0 }
        return {
            ...
            (r = e).hasAdvTab || r.hasUploadUrl || r.hasUploadHandler
              ? {
                  ...
                  tabs: N([
                    [Ee(r)],
                    r.hasAdvTab ? [Le(r)] : [],
                    r.hasUploadTab && (r.hasUploadUrl || r.hasUploadHandler) ? [je(r)] : [],
                  ]),
                }
    ...
    $e = function (e) {
        ...
        u = {
          onSubmit: function (n) {
            return function (e) {
              ...
              s.execCommand('mceUpdateImage', !1, ke(t, n.hasAccessibilityOptions)),
      ...
      return {
        open: function () {
          Pe(e).then(qe(u)).then(e.windowManager.open)
        },
      }
    },
    Je = function (u) {
              ...
              void ((l = he((t = u)))
                ? ((n = ce(function (e) {
                  ...
                  (r = c(c({}, n), e)).src
                    ...
                    : ((i = t),
                      (a = l) &&
                        ((o = i.dom.is(a.parentNode, 'figure.image') ? a.parentNode : a),
                        i.dom.remove(o),
                        i.focus(),
                        i.nodeChanged(),
    ...
    Ke = function (a) {
      return function (e) {
        for (
          ...
          ;(t = i.attr('class')) &&
            /\bimage\b/.test(t) &&
            (i.attr('contenteditable', a ? 'false' : null), Se.each(i.getAll('figcaption'), r))
        }
      }
    }
  i.add('image', function (e) {
    ...
    ;(t = e).on('PreInit', function () {
      ...
      n.ui.registry.addMenuItem('image', { icon: 'image', text: 'Image...', onAction: $e(n).open }),
