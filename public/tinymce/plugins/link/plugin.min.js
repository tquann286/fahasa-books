...
!(function () {
  ...
  var n,
    ...
    G = function (t, n) {
      ...
      for (
        var e = t.cloneContents(), r = new F(e.firstChild, e), o = [], i = e.firstChild;
    ...
    rt = function (t, n) {
      ...
      return (
        ...
        (i.href =
          ((r = i.href), ('http' !== (o = g(t)) && 'https' !== o) || J(r) ? r : o + '://' + r)),
        i
      )
    },
    ot = function (l, c, f) {
    ...
    mt = function (n, t, e, r) {
      ...
      return o !== undefined
        ? st(o, e).map(function (t) {
            return {
              url: { value: t.value, meta: { text: i ? n : t.text, attach: y } },
              text: i ? n : t.text,
            }
          })
        : N.none()
      ...
      var u = { text: t.text, title: t.title },
        ...
        o = function (t, n) {
          var e,
            ...
            o =
              ((e = i),
              ('link' === (r = n.name) ? e.link : 'anchor' === r ? e.anchor : N.none()).getOr([]))
      ...
      return bt(f).then(function (t) {
        var n,
          ...
          c =
            ...
            (a = Nt(r, e, 'rel')),
            (l = Nt(r, e, 'class')),
            { url: i, text: o, title: Nt(r, e, 'title'), target: u, rel: a, linkClass: l })
        return {
          anchor: c,
          catalogs: {
            targets: Ct(f),
      ...
      ;((n = Q((t = h))), At(t, n))
        .then(function (t) {
          ...
          return (
            ...
            (a = n.anchor),
            (m = {
              url: { value: (l = a.url.getOr('')), meta: { original: { value: l } } },
              text: a.text.getOr(''),
              title: a.title.getOr(''),
              anchor: l,
              link: l,
    ...
    Rt = function (t, n) {
      ...
      n &&
        ((e = X(n)),
        /^#/.test(e) ? (r = t.$(e)).length && t.selection.scrollIntoView(r[0], !0) : Tt(n.href))
    },
    Dt = function (t) {
      return function () {
        Pt(t)
