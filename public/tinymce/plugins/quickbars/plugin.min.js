...
!(function () {
  ...
  var t,
          ...
          ;(i = u),
            new l(function (n) {
              ...
              var o = function (e) {
                ...
                s.os.isAndroid() && 'remove' !== e.type ? f.setEditorTimeout(i, t, 0) : t(),
    ...
    E = {
      ...
      none: T,
      from: function (e) {
        return null === e || e === undefined ? N : q(e)
      },
    }
  function M(e, t, n, r, o) {
    return e(n, r) ? E.some(n) : y(o) && o(n) ? E.none() : t(n, r, o)
  }
  var S,
    C = function (e) {
    ...
    O = {
      ...
      fromPoint: function (e, t, n) {
        return E.from(e.dom.elementFromPoint(t, n)).map(C)
      },
    },
    x = function (e, t) {
      var n = e.dom
    ...
    A =
      ...
      function (e, t, n) {
        for (var r = e.dom, o = y(n) ? n : k; r.parentNode; ) {
          r = r.parentNode
          var i = O.fromDom(r)
    ...
    _ =
      ...
      function (e, t, n) {
        return (
          ...
          (function (e, t) {
            if (h(e) || g(e)) throw new Error('expected a string but found: ' + e)
            return b(e) ? t : p(e) ? (!1 === e ? '' : t) : e
          })(e.getParam(t, n), n)
        )
      }),
    L = function (o) {
